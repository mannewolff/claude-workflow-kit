...
**Läuft der Skill als `/techplan #N` gegen ein fachliches Issue, geht die Angabe zusätzlich als Kommentar ans Issue:**
...
**Ohne `spec`-Block sieht ein Projekt nichts davon.** Keine Rangfolge, keine Beschreibungs-Lücken, keine Vorhaben-Notiz — `/techplan` läuft unverändert wie vor Issue #447. Der Schalter ist das Vorhandensein des Blocks, kein Feld darin.
