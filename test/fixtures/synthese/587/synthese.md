...
- fable, "Ziel verspricht, was ein Nicht-Ziel ausschließt" (BLOCKER, `gate` F10) —
  **übernommen**, aber auf einem dritten Weg. Der Mensch entschied „Scope halten":
...
- gpt-astra, "Der zweite Schadensfall liegt nicht erkennbar im Prüfbereich"
  (WICHTIG, `korrektur`) — **übernommen**, deckungsgleich mit fable Fund 1.
- fable, "Schritt 2 steht als Lieferumfang, obwohl offen ist, ob er kommt"
  (WICHTIG, `alternativen`) — **übernommen** in der Variante „verbindlich", vom
...
- fable, "'der geschärfte Text' ist zweideutig" (WICHTIG, `alternativen`) —
  **übernommen**: Maßstab ist der vorgeschlagene neue Body, nicht der geschriebene.
- gpt-astra, "Grenze der Prüfung von Verwerfungsbegründungen fehlt" (WICHTIG,
  `korrektur`) — **übernommen**, Kriterium 8 zieht die Grenze wörtlich.
- gpt-astra, "Offene Frage 1 ist bereits entschieden" (WICHTIG, `korrektur`) —
  **übernommen**: Die Frage ist zur Festlegung geworden.
- gpt-astra, "Eine nicht abgeschlossene Prüfung hat kein definiertes Ergebnis"
  (WICHTIG, `alternativen`) — **übernommen** in der Variante „keine
  Wiederholung", als neues Kriterium 6.
- fable, "Erster Zielsatz ist die Lösung von Schritt 2" (HINWEIS) — **übernommen**.
- fable, "Begründungen in den Kriterien" (HINWEIS) — **übernommen**, die
  Begründungssätze stehen jetzt im Ziel.
- fable, "Kriterium 6 ist eine Abnahmeregel" (HINWEIS) — **übernommen** als
...
- fable, "`## Herkunft`" (HINWEIS) — **übernommen** in der zweiten Variante: als
  Halbsatz ins Ziel gezogen, der Abschnitt entfällt.
- gpt-astra, "Schreibverbot sollte sich auf Korrekturen beziehen" (HINWEIS,
  `korrektur`) — **übernommen**, Nicht-Ziel 4 unterscheidet jetzt zwischen
