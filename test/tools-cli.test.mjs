...
function syncFixture(praefix, { installZeilen, kitVersion = "1.26.0" } = {}) {
  ...
  for (const datei of ["board.mjs", "night.mjs", "checks.mjs", "spec.mjs", "preise.mjs", "aufwand.mjs"]) {
...
const BLOB_KONSTANTEN = ["CONFIG_EXAMPLE_B64", "CLAUDE_WORKFLOW_MD_B64", "CLAUDE_FACHPLAN_MD_B64", "CLAUDE_PLAN_MD_B64", "BOARD_MJS_B64", "NIGHT_MJS_B64", "CHECKS_MJS_B64", "SPEC_MJS_B64", "PREISE_MJS_B64", "AUFWAND_MJS_B64", "GATE_MJS_B64", "PRE_COMMIT_B64", "SKILLS_B64"];
